...
"}"));
        ...
        verticalSpacer_3 = new QSpacerItem(20, 187, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Expanding);
...
"}"));
        ...
        verticalSpacer_2 = new QSpacerItem(20, 188, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Expanding);

        gridLayout->addItem(verticalSpacer_2, 0, 1, 1, 1);

        horizontalSpacer_2 = new QSpacerItem(223, 20, QSizePolicy::Policy::Expanding, QSizePolicy::Policy::Minimum);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        usernameEdit->setText(QCoreApplication::translate("MainWindow", "vfang", nullptr));
