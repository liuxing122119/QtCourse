    ...
    , ui(new Ui::MainWindow)
{
    ...
    ui->actionShowLineNumbers->setChecked(true);
...
void MainWindow::on_actionShowLineNumbers_triggered()
{
    CodeEditor *codeEdit = qobject_cast<CodeEditor*>(ui->textEdit);
    if(codeEdit){
        codeEdit->setLineNumberVisible(ui->actionShowLineNumbers->isChecked());
    }
}
