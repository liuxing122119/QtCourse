...
public:
    ...
    void setupUi(QDialog *ReplaceDialog)
    {
        ...
        ReplaceDialog->resize(437, 164);
        ReplaceDialog->setMaximumSize(QSize(437, 164));
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/images/Replace.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ReplaceDialog->setWindowIcon(icon);
        formLayout = new QFormLayout(ReplaceDialog);
        ...
        formLayout->setLayout(0, QFormLayout::ItemRole::LabelRole, horizontalLayout_5);
